# THIS IS AN ALTERED VERSION OF THE LOADIMAGE SCRIPT WHERE WE
# USE AN ALTERNATIVE IMAGE SMOOTHING FUNCTION
#-------------------------------------------------------------
#load libraries
#-------------------------------------------------------------
library("png")
...
#-------------------------------------------------------------
loadSinglePersonsData <- function(DPI,groupNr,groupMemberNr,folder, sigma){
  ...
  for(i in 1:5)
  {
    prepared[[i]] <- smoothImage(prepared[[i]], sigma)
  }  
